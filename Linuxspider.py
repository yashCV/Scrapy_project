...
class Linuxspider(scrapy.Spider):
    ...
    def parse_dir_contents(self,response):
        ...
        #short_description
        short_desc = response.xpath('//div[@class="wpb_text_column wpb_content_element  lf-pdp-header-text"]/div/p//span/text() | //div[@class="wpb_text_column wpb_content_element  lf-cloud-enginer-header-text"]/div//p/text() | //div[@class="wpb_text_column wpb_content_element  lf-pdp-header-text"]/div/p//em/text()').extract()
        ...
        #what_will_learn
        what_will_learn = response.xpath('//div[@id="lf_pdp_fundamentals_who_is_it_for_view"]/section[2]/div[@class="lf-pdp-content"]/div/text() | //div[@class="wpb_row vc_row-fluid vc_row inner_row  vc_custom_1590323591690 lf-cloud-enginer-learn-more-section"]/div[2]/div/div/div//div[@class="iwt-text"]/text()').extract()
        ...
        #prerequisites
        prerequisites = response.xpath('//div[@class="wpb_wrapper"]//div[@class="lf_pdp_fundamentals-prerequisites-lab-info lf-pdp-component-container"][1]/section/article/ul//li/text() | //div[@class="wpb_wrapper"]//div[@class="lf_pdp_fundamentals-prerequisites-lab-info lf-pdp-component-container"][1]/section/article/ul//li//span/text() | //div[@class="wpb_wrapper"]//div[@class="lf_pdp_fundamentals-prerequisites-lab-info lf-pdp-component-container"][1]/section/article/text() | //div[@class="wpb_wrapper"]//div[@class="lf_pdp_fundamentals-prerequisites-lab-info lf-pdp-component-container"][1]/section/article/ul//li//a//i/text()').extract()
        ...
        reviewer_rating = [rat.strip() for rat in reviewer_rating]
